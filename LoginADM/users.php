...
<body>
    ...
    <form method="post">
        ...
        <input type="number" name="tipo_usuario" min="1" max="2" placeholder="Permissão">
    ...
    <form method="post">
        ...
        <input type="number" name="atualizar_tipo_usuario" min="1" max="2" placeholder="Permissão" required>
